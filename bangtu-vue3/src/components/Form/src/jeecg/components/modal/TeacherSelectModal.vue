...
<script lang="ts">
  ...
  import { getTeacherList } from '/@/api/common/api';
  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      ...
      const [{ rowSelection, visibleChange, indexColumnProps, getSelectResult, handleDeleteSelected, selectRows }] = useSelectBiz(getTeacherList, getBindValue);
      ...
      const columns = [
        ...
        },
        {
          ...
          align:"center",
          customRender:({record}) => {
            return h('img',{src:record.headImg,style:'height:50px;width:80px;margin-left:55px'})
          },
        },
        {
          title: '姓名',
