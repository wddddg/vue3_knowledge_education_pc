...
<template>
  <div>
    <JSelectBiz :showButton="false" @handleOpen="handleOpen" :loading="loadingEcho" v-bind="attrs"></JSelectBiz>
    <CouponSelectModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></CouponSelectModal>
  </div>
</template>
<script lang="ts">
  import CouponSelectModal from './modal/CouponSelectModal.vue';
