...
import JSelectTeacher from './jeecg/components/JSelectTeacher.vue';
import JSelectMember from './jeecg/components/JSelectMember.vue';
import JSelectRole from './jeecg/components/JSelectRole.vue';
import JSelectRelBiz from './jeecg/components/JSelectRelBiz.vue';
import JSelectCoupon from './jeecg/components/JSelectCoupon.vue'
import JImageUpload from './jeecg/components/JImageUpload.vue';
import JMsUpload from './jeecg/components/JMsUpload.vue';
...
import JMsTreeSelect from './jeecg/components/JMsTreeSelect.vue';
...
componentMap.set('JSelectTeacher', JSelectTeacher);
componentMap.set('JSelectMember', JSelectMember);
componentMap.set('JSelectUser', JSelectUser);
componentMap.set('JSelectRole', JSelectRole);
componentMap.set('JSelectRelBiz', JSelectRelBiz);
componentMap.set('JSelectCoupon',JSelectCoupon)
componentMap.set('JImageUpload', JImageUpload);
componentMap.set('JMsUpload', JMsUpload);
...
componentMap.set('JMsTreeSelect', JMsTreeSelect);
