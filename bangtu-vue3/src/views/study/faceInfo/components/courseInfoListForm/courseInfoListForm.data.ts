...
export const step2Schemas: FormSchema[] = function (showTable, switchType,isEdit,provinceOptions,selectProvince,cityOptions,selectCity,areaOptions,selectArea) {
  return [
    {
      label: '收费规则',
      field: 'costType',
