...
enum Api {
  ...
  exportXls = '/course/courseOfflineUserRecord/exportXls',
  ...
  courseOfflineUserRecord ='/course/courseOfflineUserRecord/list', 
  courseOfflineUserRecordEdit ='/course/courseOfflineUserRecord/edit', 
  rollcallBatch ='/course/courseOfflineUserRecord/rollcallBatch', 
 ...
 * @param params
 */
      export const courseOfflineUserRecord = (params) =>
      defHttp.get({url: Api.courseOfflineUserRecord, params});
      
/**
 * 学员点名批量删除
 * @param params
 */
 export const rollcallBatch = (params, handleSuccess) => {
  Modal.confirm({
    title: '确认销课',
    content: '选中数据是否销课',
    okText: '确认',
    cancelText: '取消',
    onOk: () => {
      return defHttp.post({url: Api.rollcallBatch, data: params}, {joinParamsToUrl: true}).then(() => {
        handleSuccess();
      });
    }
  });
 ...
 * @param params
 */
      export const courseOfflineUserRecordEdit = (params) =>
      defHttp.put({url: Api.courseOfflineUserRecordEdit, params});
