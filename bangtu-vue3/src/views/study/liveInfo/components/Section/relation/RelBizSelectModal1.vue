...
<template>
  <div>
    ...
    <BasicModal v-bind="$attrs" @register="register" :title="modalTitle" width="950px" @ok="handleOk" destroyOnClose @visible-change="visibleChange">
...
<script lang="ts">
  ...
  import ClassListTab from '/@/components/Form/src/jeecg/components/relbiz/ClassListTab.vue';
  import CourseListTab from '/@/components/Form/src/jeecg/components/relbiz/CourseListTab.vue';
  import ExamListTab from '/@/components/Form/src/jeecg/components/relbiz/ExamListTab.vue';
  import BookListTab from '/@/components/Form/src/jeecg/components/relbiz/BookListTab.vue';
