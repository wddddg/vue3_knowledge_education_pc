...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit, refs }) {
      //注册弹框
      const [registerTable, { reload, getSelectRows, setProps }] = useTable()
      ...
      const [{ rowSelection, indexColumnProps, visibleChange, getSelectResult }] = useSelectBiz(list, getBindValue);
      // if(props.params){
      ...
      const searchInfo = ref({'courseType': 2});
