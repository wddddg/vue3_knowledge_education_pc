<template>
  <BasicDrawer @register="registerBaseDrawer" :title="title" :isDetail="false"  width="1200"   destroyOnClose bodyStyle="background: #f0f2f5;">
...
<script lang="ts" name="BookInfoFrom-BookInfoFrom" setup>
    import {ref, computed, unref,defineComponent} from 'vue'
    import { BasicForm, useForm } from '/@/components/Form';
    import { Card } from 'ant-design-vue';
    import { PageWrapper } from '/@/components/Page';
    import { schemasClass,schemasCharge,schemasCentont  } from './BookInfoForm.data';
    ...
    const [registerBaseDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
      ...
      isShowFooter.value = data.isEdit
    ...
    // 注册
    const [registerClass,{ validate:ClassData,setFieldsValue:setClassData,updateSchema } ] = useForm({
        schemas: schemasClass(rootTreeData,threeCateId,twoCateId,oneCateId,userInfo.userRoleType),
        baseColProps: {
        span: 6,
        },
