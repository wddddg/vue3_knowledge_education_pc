<template>
  <div>
    ...
    <!--字典弹窗-->
    <SystemCategoryModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="systemCategory-systemCategory" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import SystemCategoryModal from './components/SystemCategoryModal.vue';
  import {columns,searchFormSchema} from './SystemCategory.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteSystemCategory, batchDeleteSystemCategory, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './SystemCategory.api';
  ...
  async function handleDelete(record) {
    await deleteSystemCategory({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteSystemCategory({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
